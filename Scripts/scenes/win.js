...
(function (scenes) {
    var Win = (function (_super) {
        ...
        Win.prototype.start = function () {
            ...
            //current score
            this._currentScore = new objects.Label("Your Score: " + Math.round(scoreValue), "Bold 50px Merienda One", "#ffcc00", config.Screen.CENTER_X - 280, config.Screen.CENTER_Y - 100, true);
